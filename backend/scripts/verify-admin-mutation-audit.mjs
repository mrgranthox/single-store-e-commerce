...
const hasKnownAuditHelperDelegation = (body) =>
  /\b(logAdminMutation|record[A-Za-z0-9_]*AdminMutation|recordShipmentMutation|createInitialShipmentInTransaction|persistOrderWarehouseAssignmentInTransaction|recordCatalogMutation|recordMarketingMutation|recordReturnAdminMutation|recordShipmentAdminMutation|recordSupportAdminMutation|recordContentAdminMutation)\s*\(/.test(
    body
  );
