...
export const permissionCatalog = [
  ...
  { code: "admin.users.read", domain: "admin", description: "Read admin user directory and detail." },
  { code: "admin.users.create", domain: "admin", description: "Create admin users linked to identity records." },
  { code: "admin.users.update", domain: "admin", description: "Update admin profile metadata." },
  { code: "admin.users.manage_roles", domain: "admin", description: "Assign and update admin roles." },
  { code: "admin.users.update_status", domain: "admin", description: "Suspend and reactivate admin users." },
  { code: "admin.users.sessions.read", domain: "admin", description: "Read admin session inventories." },
  { code: "admin.users.sessions.revoke", domain: "admin", description: "Revoke admin sessions." },
  { code: "admin.users.invitations.manage", domain: "admin", description: "Create, resend, and revoke admin invitations." },
