...
export const adminEndpointCatalog = [
  ...
  endpoint("catalog.variants.bulkArchive", "catalog", "POST", "/api/admin/catalog/products/:productId/variants/bulk-archive", "Archive multiple product variants in one request."),
  ...
  endpoint("shipments.bulkStatus", "orders", "POST", "/api/admin/shipments/bulk-status", "Bulk set shipment status for many ids."),
