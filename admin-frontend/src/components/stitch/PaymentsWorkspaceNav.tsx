...
const tabs = [
  ...
  { to: "/admin/refunds", label: "Refunds", end: true },
  { to: "/admin/payments/failed-investigations", label: "Failed payments", end: true },
  { to: "/admin/finance/exceptions", label: "Finance exceptions", end: true }
] as const;

/**
 * High-visibility secondary nav across the payments / refunds / finance workspace (sidebar complement).
 */
export const PaymentsWorkspaceNav = ({ className }: { className?: string }) => (
  <nav
    className={clsx(
