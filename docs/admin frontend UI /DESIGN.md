...
### Implementation stack (admin web)
- **Use React with Vite** and client-side routing (e.g. React Router).
- **Do not use Next.js** (no App Router, no `next/*` imports, no RSC-by-default patterns) for this admin product.
