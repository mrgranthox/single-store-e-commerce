/** Storefront identity — Tees collection */
export const STORE_NAME_FULL = "Tees collection";
export const STORE_NAME_SHORT = "Tees";
export const LOGO_SRC = "/tees-logo.jpeg";
export const LOGO_ALT = `${STORE_NAME_FULL} logo`;
